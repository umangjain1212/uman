import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, L as Link, X, B as Button } from "./index-_0pz2Sn_.js";
import { p as products, C as ChevronRight, P as ProductCard } from "./products-DdFxKeR5.js";
import { I as Input } from "./input-BgMxDUsQ.js";
import { m as motion } from "./proxy-D2zCQ6DC.js";
import "./leaf-BTNEIXZ3.js";
/**
...
function Shop() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 py-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge-organic mb-3 inline-flex", children: "Kacchi Ghani Collection" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 py-10", children: [
      ...
      filtered.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: filtered.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
