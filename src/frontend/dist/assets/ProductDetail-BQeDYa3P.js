import { c as createLucideIcon, u as useParams, a as useNavigate, b as useCartStore, r as reactExports, j as jsxRuntimeExports, L as Link, B as Button, m as motion, X, S as ShoppingCart, d as ue } from "./index-C6yaLQPH.js";
import { g as getProductById, p as products, C as ChevronRight, B as Badge, P as ProductCard } from "./products-Dp9Tl7QG.js";
import { S as SEO } from "./SEO-rx0VowqY.js";
import { I as Input } from "./input-DnngnSnX.js";
import { S as Separator } from "./separator-DsYkZUq9.js";
import { L as Leaf } from "./leaf-D4U0Ib3k.js";
import { T as Tag, M as Minus, P as Plus } from "./tag-dn83EvCV.js";
import "./index-Dq-5sPHd.js";
/**
...
function ProductDetail() {
  ...
  const defaultVariantIdx = (product == null ? void 0 : product.variants) ? product.variants.length - 1 : 0;
  const [selectedVariantIdx, setSelectedVariantIdx] = reactExports.useState(defaultVariantIdx);
  ...
  const cartItemId = activeVariant ? `${product.id}-${activeVariant.size.replace(/\s+/g, "")}` : product.id;
  ...
  function handleApplyCoupon() {
    ...
    if (VALID_COUPONS[code] !== void 0) {
      setAppliedCoupon(code);
      setCouponDiscount(VALID_COUPONS[code]);
      setCouponError("");
      ue.success(`Coupon applied! ${VALID_COUPONS[code]}% discount`, {
