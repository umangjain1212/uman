import { c as createLucideIcon, j as jsxRuntimeExports, f as cn, r as reactExports, i as Mail, P as Phone, M as MapPin, B as Button } from "./index-_0pz2Sn_.js";
import { I as Input } from "./input-BgMxDUsQ.js";
import { u as useActor, L as Label, c as createActor } from "./backend-vvotJGzh.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10 max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary rounded-2xl p-8 text-primary-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-bold mb-6", children: "Reach Us Directly" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-5", children: contactInfo.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary-foreground/15 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "w-5 h-5 text-primary-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/70 text-xs font-medium uppercase tracking-wide mb-0.5", children: item.label }),
                  ...
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground font-medium", children: item.value })
                ] })
              ] }, item.label)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
