import { c as createLucideIcon, j as jsxRuntimeExports, m as motion, L as Link, B as Button, r as reactExports } from "./index-0GmdxHi9.js";
import { p as products, P as ProductCard } from "./products-k6AZ59U8.js";
import { S as SEO } from "./SEO-D589WDNs.js";
import { A as ArrowRight } from "./arrow-right-C5ruSTN8.js";
import { L as Leaf } from "./leaf-I9NH2avV.js";
import { D as Droplets, S as Sprout } from "./sprout-CpTP3wyO.js";
import { C as ChevronRight } from "./chevron-right-BhXVlcOl.js";
import "./badge-BBaXIBqF.js";
/**
      ...
      children: [
        heroSlides.map((slide, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: i === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: slide.imageUrl,
                alt: "",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-30 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full px-8 md:px-16 lg:px-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-['Playfair_Display'] text-3xl sm:text-4xl md:text-5xl font-bold text-white leading-tight", children: (() => {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 mb-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/90 text-xs sm:text-sm uppercase tracking-widest font-medium", children: heroSlides[current].subtitle })
              ] }),
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-background", id: "products", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5", children: products.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
