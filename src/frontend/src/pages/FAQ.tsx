...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Farm72 currently offers a range of pure cold pressed oils and natural products: Coconut Oil, Sesame/Til Oil (available in 1 liter and 500ml), Black Mustard Oil (1 liter), Yellow Mustard Oil (1 liter), and Burance Juice (500ml). All products are 100% natural, cold pressed, and free from chemicals and preservatives.",
  },
  {
    id: 12,
      ...
      <section className="py-14">
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
          <div className="space-y-3" data-ocid="faq.list">
            ...
            {faqs.slice(12).map((faq, i) => (
              <FAQItem key={faq.id} faq={faq} index={12 + i} />
            ))}
          </div>
